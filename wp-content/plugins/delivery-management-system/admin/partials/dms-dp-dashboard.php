...
<div class="dashboard">
    ...
    <div class="item-container pt-5 text-center">
        <a href="admin.php?page=dms_dp_orders" class="text-decoration-none text-dark">
            <div class="item">
                <img class="icon" src="<?php echo esc_url(DMS_PLUGIN_URL . "assets/images/delivery-icon.png"); ?>" alt="">
                <h4 class="pt-3">Incoming Orders</h4>
            </div>
        </a>
        <a href="admin.php?page=dms_dp_locations" class="text-decoration-none text-dark">
            <div class="item">
                <img class="icon" src="<?php echo esc_url(DMS_PLUGIN_URL . "assets/images/google-maps.png"); ?>" alt="">
                <h4 class="pt-3">Order Locations</h4>
            </div>
        </a>
    </div>
</div>
